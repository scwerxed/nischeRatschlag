...
> = {
  ...
  wien:              { name: 'Wien',              geo: { lat: 48.21, lng: 16.37 }, keywords: ['Wien', 'Schönbrunn', 'Prater', 'Alte Donau', 'Wienerwald', 'Hundertwasserhaus', 'Urlaub Wien'] },
  oberoesterreich:   { name: 'Oberösterreich',    geo: { lat: 47.95, lng: 13.80 }, keywords: ['Oberösterreich', 'Salzkammergut', 'Hallstatt', 'Traunsee', 'Attersee', 'Linz', 'Steyr', 'Nationalpark Kalkalpen', 'Innviertel', 'Schärding', 'Ried im Innkreis'] },
  niederoesterreich: { name: 'Niederösterreich',  geo: { lat: 48.20, lng: 15.62 }, keywords: ['Niederösterreich', 'Wachau', 'Stift Melk', 'Schneeberg', 'Rax', 'Wein Niederösterreich', 'Ötscher', 'Semmering', 'Pielachtal', 'Mostviertel', 'Carnuntum'] },
  vorarlberg:        { name: 'Vorarlberg',        geo: { lat: 47.25, lng: 9.92 },  keywords: ['Vorarlberg', 'Bodensee', 'Bregenz', 'Bregenzerwald', 'Lünersee', 'Montafon', 'Hohenems'] },
};
