...
> = {
  ...
  niederoesterreich: { name: 'Niederösterreich',  geo: { lat: 48.20, lng: 15.62 }, keywords: ['Niederösterreich', 'Wachau', 'Stift Melk', 'Schneeberg', 'Rax', 'Wein Niederösterreich', 'Ötscher', 'Semmering', 'Pielachtal', 'Mostviertel'] },
