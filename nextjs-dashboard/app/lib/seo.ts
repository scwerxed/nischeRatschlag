...
> = {
  ...
  oberoesterreich:   { name: 'Oberösterreich',    geo: { lat: 47.95, lng: 13.80 }, keywords: ['Oberösterreich', 'Salzkammergut', 'Hallstatt', 'Traunsee', 'Attersee', 'Linz', 'Steyr', 'Nationalpark Kalkalpen', 'Innviertel', 'Schärding'] },
