...
export const BAHNHOF_GROUPS: { title: string; note: string; picks: { slug: string; anreise: string }[] }[] = [
  {
    ...
    picks: [
      ...
      { slug: 'murau-murtalbahn', anreise: 'Bahnhof Murau liegt an der nostalgischen Murtalbahn – die Altstadt ist in wenigen Gehminuten erreicht' },
      { slug: 'semmeringbahn-weltkulturerbe', anreise: 'Bahnhof Semmering liegt direkt an der Weltkulturerbe-Strecke – Ausgangspunkt für den Bahnwanderweg' },
      { slug: 'mariazell-wallfahrt-ausflug', anreise: 'Die historische Mariazellerbahn endet im Ortszentrum, nur wenige Schritte zur Basilika' },
      { slug: 'bad-gastein-wasserfall', anreise: 'Bahnhof Bad Gastein liegt mitten im Ort, der Wasserfall rauscht direkt daneben' },
      { slug: 'st-anton-am-arlberg', anreise: 'Bahnhof St. Anton am Arlberg liegt zentral im Ort, kurzer Weg zu den Liften' },
      { slug: 'feldkirch-altstadt-schattenburg', anreise: 'Bahnhof Feldkirch, wenige Gehminuten zur Lauben-Altstadt' },
      { slug: 'eisenstadt-schloss-esterhazy', anreise: 'Bahnhof Eisenstadt, rund 15–20 Gehminuten zum Schloss oder kurz mit dem Stadtbus' },
    ],
  },
  {
  ...
  },
  {
    ...
    picks: [
      ...
      { slug: 'klagenfurt-stadtfuehrung', anreise: 'Vom Hauptbahnhof gut 15 Min. zu Fuß oder mit dem Stadtbus in die Altstadt' },
    ],
  },
];
