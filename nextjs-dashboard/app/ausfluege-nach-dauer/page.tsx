  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-12">
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        ...
        <Link href="/zwei-ausfluege-an-einem-tag" className="inline-block border border-green-700 text-green-700 text-sm font-semibold px-5 py-2.5 hover:bg-green-50 transition-colors" style={{ borderRadius: 6 }}>
