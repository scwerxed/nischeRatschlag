...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages = ['', '/blog', '/karte', '/routenplaner', '/ausflugsplaner', '/seen-vergleich', '/wochenendtrip', '/wandern-baden', '/hitzefreundliche-ausfluege', '/regentaugliche-ausfluege', '/aussicht-ohne-anstrengung', '/beste-ausfluege', '/ausfluege-nach-dauer', '/bahnhofsausfluege', '/feierabend-ausfluege', '/sonnenuntergang-spots', '/zwei-ausfluege-an-einem-tag', '/familienausfluege', '/badeplaetze', '/unterkuenfte/am-see', '/unterkuenfte/basislager', '/reiseinfos', '/ueber-uns', '/kontakt', '/impressum', '/datenschutz'].map((p) => ({
    url: `${BASE}${p}`,
