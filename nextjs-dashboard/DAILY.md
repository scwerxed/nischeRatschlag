...
- **Neue Artikel** (Slug vorher prüfen!) — dünn besetzte Regionen zuerst.
  Stand 2026-09-10 je Region: Kärnten 44, Burgenland 26, Steiermark 26, Salzburg 19, Tirol 19,
  Wien 10, **Oberösterreich 10, Niederösterreich 11**, Vorarlberg 10. OÖ (Innviertel/Schärding)
  und NÖ (Pielachtal/Dirndlweg) aus dem Backlog sind erledigt. Übrige Ideen: OÖ Ried/Antiesental
  (weiteres Innviertel-Ziel abseits Schärding). Wolfgangsee-Ostufer/St. Wolfgang bewusst
  **nicht** genommen — überschneidet sich zu stark mit dem bestehenden Artikel `wolfgangsee-st-gilgen`
  (Salzburg-Seite desselben Sees, inkl. Schafbergbahn).
